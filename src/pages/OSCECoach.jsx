        ...
        <div className="p-3 md:p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between mb-2 md:mb-4">
            <h2 className="text-lg md:text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
              <Stethoscope className="w-5 h-5 md:w-6 md:h-6 text-green-600" />
              <span className="hidden sm:inline">OSCE Coach</span>
              <span className="sm:hidden">OSCE</span>
            </h2>
          </div>
          <button
            onClick={createNewSession}
            className="w-full bg-green-600 text-white px-3 md:px-4 py-2 rounded-lg hover:bg-green-700 transition-colors flex items-center justify-center gap-2 text-sm md:text-base"
          >
        ...
        <div className="flex-1 overflow-y-auto">
          {sessions.length === 0 ? (
            <div className="p-3 md:p-4 text-center text-gray-500 dark:text-gray-400">
              <Stethoscope className="w-8 h-8 md:w-12 md:h-12 mx-auto mb-2 opacity-50" />
              <p className="text-xs md:text-sm">No practice sessions yet</p>
              <p className="text-xs mt-1 hidden md:block">Start practicing OSCE scenarios!</p>
            </div>
          ) : (
            ...
            <div className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-3 md:p-4">
              <form onSubmit={sendMessage} className="flex gap-2 md:gap-3">
                <input
                  ...
                  className="flex-1 px-3 md:px-4 py-2 md:py-3 text-sm md:text-base border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:text-white"
                  disabled={sendingMessage}
                />
                <button
                  type="submit"
                  disabled={!message.trim() || sendingMessage}
                  className="bg-green-600 text-white px-4 md:px-6 py-2 md:py-3 rounded-lg hover:bg-green-700 transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm md:text-base"
                >
