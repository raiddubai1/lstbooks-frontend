  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Sort Options */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-3 md:p-4 mb-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4">
            <span className="text-xs md:text-sm font-medium text-gray-700 dark:text-gray-300">Sort by:</span>
            <div className="flex gap-2 flex-wrap">
              ...
              >
                <Award className="w-3 h-3 md:w-4 md:h-4 inline mr-1 md:mr-2" />
                Badges
              </button>
            </div>
          </div>
