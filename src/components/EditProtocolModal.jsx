...
const EditProtocolModal = ({ protocol, onClose, onSuccess }) => {
  const [formData, setFormData] = useState({
    title: protocol.title || '',
    description: protocol.description || '',
    category: protocol.category || 'Operative Dentistry',
    ...
    requiredMaterials: protocol.requiredMaterials || [],
    requiredInstruments: protocol.requiredInstruments || [],
    complications: protocol.complications || [],
    postTreatmentCare: protocol.postTreatmentCare || [],
    followUp: protocol.followUp || '',
    evidenceLevel: protocol.evidenceLevel || 'Expert Opinion',
    references: protocol.references || [],
    thumbnailUrl: protocol.thumbnailUrl || '',
    videoUrl: protocol.videoUrl || '',
    diagramUrls: protocol.diagramUrls || [],
    tags: protocol.tags || [],
    verified: protocol.verified || false,
    featured: protocol.featured || false
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.put(`/treatment-protocols/${protocol._id}`, formData);
      onSuccess();
      onClose();
    } catch (err) {
      setError(err.response?.data?.error || 'Failed to update protocol');
    } finally {
      setLoading(false);
    }
  };
